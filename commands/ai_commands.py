        ...
        if (replied_message.author.bot and 
            ...
            async with channel.typing():
                ...
                if response:
                    ...
                    await message.reply("❌ Sorry, I couldn't process your follow-up question right now.", mention_author=False)
...
async def ask_manolis_gpt(interaction: discord.Interaction, question: str):
    ...
    try:
        ...
        if response_text:
            ...
            await interaction.followup.send("❌ Sorry, I couldn't process your question right now. Please try again later.", ephemeral=True)
