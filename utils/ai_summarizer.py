...
class ConversationSummarizer:
    ...
    async def generate_conversation_summary(
        ...
        try:
            ...
            prompt = self._create_summarization_prompt(
                formatted_conversation, channel_name, real_names
            )
    ...
    def _create_summarization_prompt(
        self, conversation: str, channel_name: str, real_names: list[str] = None
    ) -> str:
        """
...
{conversation}"""
    ...
    def format_summary_for_api(
        self, summary: str, channel_name: str, message_count: int
    ) -> str:
        """
        ...
        if len(formatted_summary) > max_length:
            ...
            if (
                last_period > max_length - 200
            ):  # If there's a sentence ending reasonably close
